...
export class HttpSecurityService implements IHttpSecurityService {
    ...
    getSesiones(): Observable<any> {
        return this.http.get<any>(`${environment.api}/api/usuarios/getSesiones?page=${this.paginationService.page}&pageCount=${this.paginationService.pageCount}`)
        .pipe(map((response: any) => {
            if (response.status === 200) {
                return response.data;
            } else {
    ...
    getUsuarioInfo(userName: string): Observable<any> {
        return this.http.get<any>(`${environment.api}/api/usuarios/getUsuarioInfo?userName=${userName}`)
            .pipe(map((response: any) => {
                if (response.status === 200) {
                    return response.data;
                } else {
    ...
    seguirUsuario(usuario: any): Observable<any> {
        return this.http.post<any>(`${environment.api}/api/usuarios/seguirUsuario`, usuario)
            .pipe(map((response: any) => {
                if (response.status === 200) {
                    return response.data;
                } else {
    ...
    isFollowingTheUser(userName: any): Observable<any> {
        return this.http.get<any>(`${environment.api}/api/usuarios/isFollowingTheUser?userName=${userName}`)
            .pipe(map((response: any) => {
                if (response.status === 200) {
                    return response.data;
                } else {
    ...
    getFollowingUsersByUserId(id: number): Observable<any> {
        return this.http.get<any>(`${environment.api}/api/usuarios/getFollowingUsersByUserId?page=${this.paginationService.page}&pageCount=${this.paginationService.pageCount}&query=${id}`)
            .pipe(map((response: any) => {
                if (response.status === 200) {
                    return response.data;
                } else {
